...
import com.example.lalishop.Adaptador.AllCategoryAdapter;
import com.example.lalishop.Modelo.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(6, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(7, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.shirt));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.shirt));
